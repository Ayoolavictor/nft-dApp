    ...
    <div>
      ...
      <main className="h-full min-h-[calc(100vh-128px)] p-4">
        <div className="text-center">
          ...
          <p className="text-tertiary font-medium">Mint and manage your NFTs</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4  mt-6">
          <nav className="border-l-2 border-tertiary p-4">
          ...
          <nav className="border-l-2 border-tertiary p-4">
            <Link to="/my-nfts" className="text-xl font-bold">
              Manage My NFTs
            </Link>
